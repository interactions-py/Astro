...
class Info(naff.Extension):
    ...
    async def info(self, ctx: naff.InteractionContext):
        ...
        embed.add_field(
            "What is this for?",
            "Astro is the main bot powering moderation and other utilities in the interactions.py"
            " support server. The goal of Astro is to make searching simple, and automate our"
            " moderation process. Whether that's creating tags with autocompleted suggestions, code"
            " examples, or interactive tutorials: Astro has you covered. Interactions should be"
            " simple to understand, and coding them is no different.",
        )
        embed.add_field(
        ...
        embed.add_field(
            ...
            "Please check out the official GitHub repository which holds the source code of this"
            " bot here: https://github.com/interactions-py/Astro",
        )
